...
const curaselList = [
...

    {
        ...
        bgColor: '',
        descripton: `“We have been working with the 0x team for 3 years now and their APIs are a great choice for any builders out there looking for ultimate liquidity aggregation for their users. We definitely recommend looking into 0x as a simple, ready-made, plug and play solution.”`
    },
...

    {
        ...
        bgColor: '',
        descripton: `“With Swap API we never have to worry about new liquidity sources coming out and the infrastructure overhead of searching for the best trading routes. It’s also been super easy for us to launch trading in other chains thanks to Swap API being available in the major chains. 0x turnkey solutions have allowed us to focus on other areas of our product and make Zapper one of the most popular apps in Web3.”`
    }
];
    ...
    return (
        <div className={ style.container }>
            <div className={ style.body5_container }>
                ...
                <div>
                    <p>0x is used by fintech companies, self-custody wallets, and Web3 native organizations with millions of users across the world.</p>
                </div>
